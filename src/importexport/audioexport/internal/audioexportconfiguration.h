...
public:
    ...
    const muse::vector<int>& availableMp3BitRates() const override;

    int exportSampleRate() const override;
    void setExportSampleRate(int rate) override;
    const muse::vector<int>& availableSampleRates() const override;
    ...
    const muse::vector<muse::audio::AudioSampleFormat>& availableSampleFormats(const QString& extension) const override;
