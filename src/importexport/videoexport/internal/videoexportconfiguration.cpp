...
static const muse::vector<std::string> AVAILABLE_RESOLUTIONS = { "2160p", "1440p", "1080p" };
...
const muse::vector<std::string>& VideoExportConfiguration::availableResolutions() const
{
