...
{
public:
    static void addChordParentheses(Chord* chord, muse::vector<Note*> notes, bool addToLinked = true, bool generated = false);
    static void removeChordParentheses(Chord* chord, muse::vector<Note*> notes, bool addToLinked = true, bool generated = false);
...
private:
    ...
    static void undoAddParenthesesToNotes(Chord* chord, muse::vector<Note*> notes, bool addToLinked = true, bool generated = false);
    static void undoRemoveParenthesesFromNote(Chord* chord, Note* note, Parenthesis* leftParen, bool removeFromLinked = true);
    static void undoClearParenthesisGroup(Chord* chord, muse::vector<Note*> notes, Parenthesis* leftParen, Parenthesis* rightParen,
                                          bool removeFromLinked = true);

    static void doAddNoteParentheses(Chord* chord, muse::vector<Note*> notes, Parenthesis* leftParen, Parenthesis* rightParen);
