...
private:
    ...
    static void layout2(Beam* item, const LayoutContext& ctx, const muse::vector<ChordRest*>& chordRests, SpannerSegmentType, int frag);

    static void createBeamSegments(Beam* item, const LayoutContext& ctx, const muse::vector<ChordRest*>& chordRests);
