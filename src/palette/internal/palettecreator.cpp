...
PalettePtr PaletteCreator::newTextPalette(bool defaultPalette)
{
    ...
    if (!defaultPalette) {
        ...
        static const std::vector<PlayTechAnnotationInfo> playTechAnnotationsMaster = {
            { QT_TRANSLATE_NOOP("palette", "dÃƒÂ©tachÃƒÂ©"),   PlayingTechniqueType::Detache },
            { QT_TRANSLATE_NOOP("palette", "martelÃƒÂ©"),   PlayingTechniqueType::Martele },
...
PalettePtr PaletteCreator::newGuitarPalette(bool defaultPalette)
{
    ...
    sp->appendElement(capoLine, QT_TRANSLATE_NOOP("palette", "BarrÃƒÂ© line"), 0.8);
