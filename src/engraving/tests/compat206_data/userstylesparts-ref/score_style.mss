...
<museScore version="4.60">
  <Style>
    ...
    <systemTextFramePadding>0.5</systemTextFramePadding>
    <systemTextFrameWidth>0.2</systemTextFrameWidth>
    ...
    <staffTextPosBelow x="0" y="3.5"/>
    <staffTextMinDistance>0.5</staffTextMinDistance>
    <staffTextFrameType>0</staffTextFrameType>
    <staffTextFramePadding>0.5</staffTextFramePadding>
    <staffTextFrameWidth>0.2</staffTextFrameWidth>
    ...
    <user1Name>Style1</user1Name>
    <user1FontFace>FreeSans</user1FontFace>
    <user1FontSize>24</user1FontSize>
    ...
    <user1Align>center,top</user1Align>
    <user1Offset x="0" y="0"/>
    ...
    <user2Name>Style2</user2Name>
    <user2FontFace>MuseJazz Text</user2FontFace>
    <user2FontSize>12</user2FontSize>
    ...
    <user2Align>right,top</user2Align>
    <user2Offset x="0" y="0"/>
    ...
    <user3Name>Style3</user3Name>
    <user3FontFace>FreeSans</user3FontFace>
    <user3FontSize>12</user3FontSize>
    ...
    <user3Align>left,center</user3Align>
    <user3Offset x="0" y="0"/>
    ...
    <user4Name>Style4</user4Name>
    <user4FontFace>FreeSerif</user4FontFace>
    <user4FontSize>12</user4FontSize>
    ...
    <user4Align>center,center</user4Align>
    <user4Offset x="0" y="0"/>
    ...
    <user5Name>Style5</user5Name>
    <user5FontFace>FreeSerif</user5FontFace>
    <user5FontSize>15</user5FontSize>
    ...
    <user5Align>left,bottom</user5Align>
    <user5Offset x="0" y="0"/>
    ...
    <user6Name>Style6</user6Name>
    <user6FontFace>FreeSerif</user6FontFace>
    <user6FontSize>12</user6FontSize>
    <user6LineSpacing>1</user6LineSpacing>
    <user6FontSpatiumDependent>0</user6FontSpatiumDependent>
    <user6FontStyle>1</user6FontStyle>
    <user6Color r="0" g="0" b="0" a="255"/>
    <user6Align>center,bottom</user6Align>
    <user6Offset x="0" y="0"/>
    ...
    <user7Name>Style7</user7Name>
    <user7FontFace>FreeSerif</user7FontFace>
    <user7FontSize>12</user7FontSize>
    <user7LineSpacing>1</user7LineSpacing>
    <user7FontSpatiumDependent>0</user7FontSpatiumDependent>
    <user7FontStyle>2</user7FontStyle>
    <user7Color r="0" g="0" b="0" a="255"/>
    <user7Align>right,bottom</user7Align>
    <user7Offset x="0" y="0"/>
